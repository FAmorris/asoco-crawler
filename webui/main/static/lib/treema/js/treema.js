...
TreemaNode = (function () {
    ...
    TreemaNode.prototype.showErrors = function () {
        var childErrors, deepestTreema, e, error, erroredTreemas, errors, message, messages, ownErrors, path, subpath,
            treema, _i, _j, _k, _len, _len1, _len2, _ref, _results;
        if (this.justCreated) {
            return;
        }
...
(__init = function () {
    var AnyNode, ArrayNode, BooleanNode, NullNode, NumberNode, ObjectNode, StringNode, _ref, _ref1, _ref2, _ref3, _ref4,
        _ref5;
    ...
    TreemaNode.setNodeSubclass('object', ObjectNode = (function (_super) {
        ...
        ObjectNode.prototype.getChildSchema = function (key_or_title) {
            ...
            var add = this.schema.additionalProperties;
            if (add) {
                return add
            }
            return {};
...
//定义几个工具函数
var __hasProp = {}.hasOwnProperty,//直接使用object的hasOwnProperty函数
    __extends = function (child, parent) {
        for (var key in parent) {
            if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
